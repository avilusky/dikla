...
afterDatasetsDraw(chart) {
    ...
    const centerY = (chart.chartArea.top + chart.chartArea.bottom) / 2;
                    ...
                    // סה"כ במיליונים
                    const totalInMillions = (totalSum / 1000).toFixed(0);
const formattedTotal = Number(totalInMillions).toLocaleString('en-US');
                    
                    ctx.fillStyle = '#1e40af';
                    ctx.font = 'bold 24px system-ui';
                    ctx.textAlign = 'center';
                    ctx.textBaseline = 'middle';
                    ctx.fillText('₪' + formattedTotal + 'M', centerX, centerY - 10);
...
afterDatasetsDraw(chart) {
    ...
    const centerY = (chart.chartArea.top + chart.chartArea.bottom) / 2;
                    ...
                    // סה"כ במיליונים
                    const totalInMillions = (totalSumRisk / 1000).toFixed(0);
const formattedTotal = Number(totalInMillions).toLocaleString('en-US');
                    ...
                    ctx.textAlign = 'center';
                    ctx.textBaseline = 'middle';
                    ctx.fillText('₪' + formattedTotal + 'M', centerX, centerY - 6);
        ...
        chartInstances.slide10.critical = new Chart(ctx2, {
            ...
            plugins: [{
                ...
                afterDatasetsDraw(chart) {
                    ...
                    // סכום במיליוני
                    const totalInMillions = (totalSumCritical / 1000).toFixed(0);
const formattedTotal = Number(totalInMillions).toLocaleString('en-US');
                    ...
                    ctx.textAlign = 'center';
                    ctx.textBaseline = 'middle';
                    ctx.fillText('₪' + formattedTotal + 'M', centerX, centerY - 8);
