    ...
    chartInstances.slide9.breakdown = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                ...
                { 
                    label: 'התאמות לענין - תביעות והוצאות', 
                ...
                { 
                    label: 'ביטול הפסדים (הפסדים) בלון', 
    ...
    chartInstances.slide16.breakdown = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                ...
                { 
                    label: 'הפחתת הוצאות (הפסדים) בלון רכישה חזין מכבידי', 
